...
import 'package:poke_test/presentation/globals/extensions/widgets_ext.dart'; // Tu ruta real del modelo

class PokemonArtworkW extends StatelessWidget {
  const PokemonArtworkW({super.key, required this.pokemon});

  // Recibe el objeto para acceder limpiamente a la propiedad de la imagen
